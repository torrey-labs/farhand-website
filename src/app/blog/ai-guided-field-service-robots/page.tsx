...
export default function Post() {
  return (
    ...
    >
      ...
      <p>
        Robots are fundamentally different from traditional industrial equipment. They&apos;re software-defined, highly configurable, and their failure modes combine mechanical, electrical, and software issues. A technician who&apos;s great with HVAC systems isn&apos;t automatically qualified to debug a cobot&apos;s motion planning errors.
      </p>
      <p>
        The traditional model — travelling or regional technicians, OEM service contracts, in-house specialists — doesn&apos;t scale. <Link href="/services/robots" style={{ color: 'var(--accent-green)' }}>Robot field service</Link> requires a new approach.
      </p>

      <h2 style={{ fontSize: '28px', color: 'var(--foreground)', marginTop: '2.5rem', marginBottom: '1rem', fontWeight: 400 }}>AI changes the equation</h2>
      <p>
        AI-guided service means loading the <strong>full manual into context</strong> — SOPs, wiring diagrams, error codes, firmware changelogs, repair history. No chunking. No retrieval errors. No missed context. When a technician arrives, they have step-by-step guidance built from your own documentation.
      </p>
      <p>
      ...
      <p>
        At <Link href="/" style={{ color: 'var(--accent-green)' }}>Farhand</Link>, we combine AI with on-demand technicians. Our <Link href="/#relay" style={{ color: 'var(--accent-green)' }}>Relay platform</Link> learns your documentation and guides technicians during repairs. Every debrief improves the AI. Your knowledge compounds over time.
      </p>
      <p>
