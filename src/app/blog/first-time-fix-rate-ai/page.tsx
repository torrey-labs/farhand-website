...
export default function Post() {
  return (
    ...
    >
      <p>
        First-time fix rate is the single most important metric in field service. Fix it the first time: the customer is happy, costs are contained, and the technician is free for the next job. Miss it: you&apos;re looking at <strong>2 more visits, 14 extra days, and a frustrated customer</strong>.
      </p>
      ...
      <p>
        AI-guided field service doesn&apos;t replace technicians. It makes every technician as good as your best one. Here&apos;s what happens in practice:
      </p>
      <p>
      ...
      <p>
        <strong>During the visit:</strong> The technician follows AI-guided, step-by-step instructions specific to this exact machine, this exact issue. No guesswork. No flipping through 400-page manuals.
      </p>
      <p>
        <strong>After the visit:</strong> The resolution is captured, enriching the knowledge base. The next technician who sees a similar issue gets even better guidance.
      </p>
      <p>
      ...
      <p>
        <Link href="/" style={{ color: 'var(--accent-green)' }}>Farhand</Link> combines AI with on-demand technicians to deliver this across <Link href="/services/robots" style={{ color: 'var(--accent-green)' }}>robots</Link>, <Link href="/services/industrial-robots" style={{ color: 'var(--accent-green)' }}>industrial robots</Link>, <Link href="/services/industrial-machinery" style={{ color: 'var(--accent-green)' }}>industrial machinery</Link>, <Link href="/services/medical-equipment" style={{ color: 'var(--accent-green)' }}>medical equipment</Link>, and more. Right diagnosis. Right parts. First visit. Every time.
      </p>
