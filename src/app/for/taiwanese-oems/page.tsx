...
export const metadata = {
  ...
  description: 'US field service for Taiwanese equipment OEMs — TSMC suppliers, Delta, Hiwin, Foxconn. AI-guided technicians supporting the US fab expansion.',
};
...
export default function TaiwaneseOEMsPage() {
  return (
    <VerticalLanding
      ...
      subheadline="AI-guided technicians across the US who already know your equipment — documentation, error codes, and procedures loaded before they step into the cleanroom."
      painPoints={[
      ...
      howItWorks={[
        ...
        "We deploy US-based technicians at your customer fabs. They arrive guided by AI that has read your full documentation — including the tool variants your US customers operate.",
      ...
      faqs={[
        {
          q: 'Can your technicians work in cleanroom environments?',
          a: 'Yes. Our technicians are cleanroom-certified and trained in gowning, ESD protocols, and contamination control procedures specific to semiconductor environments.',
        },
        {
          q: 'How do you handle ITAR or export-controlled equipment?',
          a: 'We work with your compliance team to ensure all technicians have appropriate clearances and that no controlled technical data is shared beyond authorized channels. Our AI processes documentation on-premise when required.',
        },
        {
        ...
        },
        {
          ...
          a: 'Yes. Our AI ingests documentation in any language. The technician receives guidance in English, informed by your original Mandarin manuals and specifications.',
        },
      ]}
    />
  );
