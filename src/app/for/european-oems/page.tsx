...
export const metadata = {
  ...
  description: 'US-nationwide field service for KUKA, ABB, Siemens, DMG MORI, Trumpf, Universal Robots, and Stäubli equipment. AI-guided technicians in every zip code.',
};
...
export default function EuropeanOEMsPage() {
  return (
    <VerticalLanding
      ...
      subheadline="AI-guided technicians across every US zip code who know your KUKA, ABB, Siemens, or DMG MORI equipment — full documentation loaded before they arrive on site."
      painPoints={[
      ...
      howItWorks={[
        ...
        "We deploy US-based technicians at your customer sites. They arrive guided by AI that has read your full documentation — no ramp-up period, no six-month training lag.",
      ...
      faqs={[
        {
          ...
          a: 'Our AI enforces your service procedures step-by-step. If your CE documentation specifies a particular test sequence or lockout procedure, the technician cannot skip it. Every step is logged for audit compliance.',
        },
        {
          q: 'Can your technicians work alongside our existing US team?',
        ...
        },
        {
          ...
          a: 'We operate under your service protocols and quality standards. Our technicians are insured, and every service event is documented to your specifications. The warranty relationship between you and your customer stays intact.',
        },
        {
          q: 'Do you support multiple European brands or just one?',
          a: 'Our technicians are AI-guided, not brand-specialized. Each job loads the specific OEM documentation for that equipment. One technician can service KUKA on Monday and ABB on Tuesday — the AI handles the context switching.',
        },
      ]}
    />
  );
