...
export const metadata = {
  ...
  description: 'Scale your field service without scaling headcount. AI-guided technicians nationwide for robot and machine OEMs.',
};
...
export default function OEMsPage() {
  return (
    <VerticalLanding
      ...
      subheadline="You built a next-gen machine. Don't run it on last-gen ops. AI-guided technicians that service your machines like your own guys — in every zip code."
      painPoints={[
      ...
      howItWorks={[
        ...
        "We deploy AI-guided technicians at your customer sites. They arrive knowing your machine — no ramp-up, no training lag.",
      ...
      faqs={[
        {
          ...
          a: "Staffing sends bodies. We send AI-guided technicians who arrive knowing your machine. They train techs. We train AI. Your documentation becomes the teacher.",
        },
        {
          q: "Can you white-label the service under our brand?",
          a: "Yes. Our technicians can represent your brand on-site. The service experience feels like your own team — because the AI is trained on your exact documentation.",
        },
        {
