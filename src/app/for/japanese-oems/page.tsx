...
export const metadata = {
  ...
  description: 'US-based, AI-guided technicians for FANUC, Yaskawa, Mitsubishi, Mazak, and Keyence equipment. Stop flying FSEs from Tokyo — we are already there.',
};
...
export default function JapaneseOEMsPage() {
  return (
    <VerticalLanding
      ...
      subheadline="AI-guided technicians across every US zip code who already know your FANUC, Yaskawa, Mitsubishi, or Mazak equipment — manuals, SOPs, and error codes loaded before they arrive."
      painPoints={[
      ...
      howItWorks={[
        ...
        "We deploy US-based technicians at your customer sites, guided by AI that has read every page of your documentation. No ramp-up, no training lag.",
      ...
      faqs={[
        {
          q: 'Can your technicians read Japanese documentation?',
          a: 'Our AI ingests documentation in any language — Japanese, English, mixed. The technician receives guidance in English, informed by your original Japanese manuals. Nothing is lost in translation because the AI reads the source directly.',
        },
        {
        ...
        {
          q: 'What if our equipment requires factory-certified technicians?',
          a: 'We work with your team to define certification requirements. Your engineers can train our technicians remotely via the Relay platform, and AI guidance ensures every procedure matches your factory standards.',
        },
        {
          q: 'Can we white-label this under our brand?',
          a: 'Yes. Our technicians represent your brand on-site. Your US customers experience what feels like your own service team — because the AI is trained on your exact documentation and procedures.',
        },
      ]}
    />
  );
