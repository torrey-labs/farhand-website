...
export const metadata: Metadata = {
  ...
  description: 'AI-guided field service for robotics and machinery OEMs. On-demand technicians in every US zip code.',
    ...
    <main className="bg-background min-h-screen">
      ...
      <section className="pt-8 pb-12 md:pb-16">
        <div className="container max-w-[900px]">
          ...
          <h2 className="max-w-[750px] font-normal mb-8">
            On-demand technicians guided by AI to install and service your robots &amp; machinery at client sites — without you building a field team.
          </h2>
          <p className="text-light-gray leading-relaxed mb-6 max-w-[700px]">
            Farhand dispatches AI-guided technicians who arrive knowing your equipment. We load your full documentation — manuals, SOPs, wiring diagrams, error codes — into our Relay™ platform. The technician gets real-time, context-aware guidance. Your customer gets same-day response. You get field intelligence back.
          </p>
          <p className="text-light-gray leading-relaxed mb-6 max-w-[700px]">
            We cover every zip code in the US. No regional hubs, no travel surcharges, no 48-hour dispatch windows. Robots, industrial machinery, medical equipment, instruments — if it needs a technician, we send one who already knows your machine.
          </p>
      ...
      <StepsList
        ...
        steps={[
          ...
          'A technician arrives guided by AI that knows your machine. No ramp-up, no training lag.',
