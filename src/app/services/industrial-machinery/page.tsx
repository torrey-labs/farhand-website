...
export const metadata = {
  ...
  description: 'AI-guided field service for industrial machinery, CNC machines, and manufacturing equipment. On-demand technicians nationwide.',
};
...
export default function IndustrialMachineryPage() {
  return (
    <VerticalLanding
      ...
      subheadline="On-demand technicians guided by AI to service your industrial machinery — CNC systems, production lines, and factory automation."
      painPoints={[
