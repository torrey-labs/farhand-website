...
export const metadata = {
  ...
  description: 'AI-guided field service for aviation ground equipment, avionics, and aircraft systems. Nationwide technician network.',
};
...
export default function GeneralAviationPage() {
  return (
    <VerticalLanding
      ...
      subheadline="AI-guided technicians for aviation ground equipment, avionics systems, and aircraft support infrastructure — with complete technical documentation on every dispatch."
      painPoints={[
