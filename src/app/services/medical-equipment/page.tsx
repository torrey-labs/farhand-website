...
export const metadata = {
  ...
  description: 'AI-guided field service for medical devices, surgical systems, and pharmacy automation. Compliance-ready technicians nationwide.',
};
...
export default function MedicalEquipmentPage() {
  return (
    <VerticalLanding
      ...
      subheadline="AI-guided technicians for medical devices, surgical robots, imaging systems, and pharmacy automation — with full documentation context on every visit."
      painPoints={[
